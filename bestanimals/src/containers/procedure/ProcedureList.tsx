...
import * as S from "./ProcedureList.styles";
    ...
    <S.ContentsContainer>
        ...
        <S.ContentBox>
          <S.Circle>
            ...
            <S.Content>
              ...
              <Link href="https://www.youtube.com/channel/UCiVAmmAhogyGENI2Kjac_Rg">
                (서울동물복지지원센터 유튜브 바로가기)
              </Link>
            </S.Content>
            <S.Line />
      ...
      <S.ContentBoxContainer $scrollY={scroll} $standardHeight={height}>
        <S.ContentBox>
          ...
          <S.Circle style={{ backgroundColor: "#C5A999" }}>
            ...
            <S.Content>
              입양을 희망하시는 분은 서울시 평생학습포털의 "반려동물 입양교육과
              반려동물 돌봄 교육"을
              <br /> 이수해 주세요. <br />
              <Link href="https://sll.seoul.go.kr/lms/requestCourse/doDetailInfo.do?course_id=ASP00001S995220220000001&class_no=01&course_gubun=1&asp_id=ASP00001&course_category_id=202102012389901&category_status=&page=1&mnid=202102146855">
                (교육 신청 안내 바로가기)
              </Link>
            </S.Content>
            <S.Line />
      ...
      <S.ContentBoxContainer $scrollY={scroll} $standardHeight={height}>
        <S.ContentBox>
          ...
          <S.NoticeBox>
            <div>
              ※ 입양대기 동물들은 동물등록과 중성화수술이 <br /> 되어 있는 것을
              아시나요?
              <br /> 서울동물복지지원센터의 유기동물들은 중성화 수술 및 동물등록
              완료 후 입양됩니다.
            </div>
          </S.NoticeBox>
          <S.DotsBox>
      ...
      <S.ContentBoxContainer $scrollY={scroll} $standardHeight={height}>
        <S.ContentBox>
          ...
          <S.NoticeBox>
            <div>
              ※ 입양 이후 모니터링 관련 정보 제공에 협조를 <br />해 주실 수
              있나요?
              <br />
              센터에서는 입양 인식개선을 위해서 보호자분의 <br /> 적극적인
              입양후기 공유를 요청 드리며, 입양동물 <br /> 정보제공에도
              적극적으로 응해 주시기 바랍니다.
            </div>
          </S.NoticeBox>
          <S.DotsBox>
